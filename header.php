...
<?php
	if(checkCookie()) {
		...
		echo "<a href=\"usermod.php\" class=\"menu\">" . $username . "</a> | posts: " . $numOfEntries . " | <a href=\"settings.php\" class=\"menu\">site admin</a> | <a href=\"rss.php\" class=\"menu\">rss</a> | <a href=\"logout.php\" class=\"menu\">logout</a>";
	} else {
